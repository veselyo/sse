...
- For detailed description of how the algorithm works, refer to [this paper](Zimmermann+Edler_von_Hoessle.pdf), which I used for designing the algorithm.
...
- Below are shown how the dimension intervals change over the iterations of SSE, eventually converging and giving us all possible vehicle designs that satisfy our requirement within our bounds. 
